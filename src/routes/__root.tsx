...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NAVDIS — UPI Dispute Navigator | RBI Rights Check" },
      ...
      { property: "og:title", content: "NAVDIS — UPI Dispute Navigator | RBI Rights Check" },
      ...
      { property: "og:url", content: "https://navdis.lovable.app/" },
      { property: "og:site_name", content: "NAVDIS" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "NAVDIS — UPI Dispute Navigator | RBI Rights Check" },
